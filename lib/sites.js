...
export async function getAllSitesAndData() {
  let body = JSON.stringify({ "criteria": {}, "fields": ["referenceId", "address", "hours", "contact", "timeZone", "locked", "description", "currency", "coordinates", "status", "parentEnterpriseUnitId", "groups", "dayparts"] })
