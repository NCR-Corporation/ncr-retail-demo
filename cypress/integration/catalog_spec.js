describe('View Catalog', function () {
  it('view categories and catalog', function () {
    ...
    cy.get(
      '.my-4 > .bg-white > .breadcrumb > .breadcrumb-item:nth-child(2) > a',
      { timeout: 10000 }
    ).click();
    ...
    cy.get(
      '.col-sm-6:nth-child(1) > .border-0 > .d-flex > .align-self-end > .h5',
      { timeout: 10000 }
    ).click();
    ...
    cy.get(
      'div > #catalog-items > .col-sm-6:nth-child(2) > .border-0 > .d-flex',
      { timeout: 10000 }
    ).click();
  });
});
